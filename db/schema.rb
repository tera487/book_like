...
ActiveRecord::Schema.define(version: 2021_06_22_054548) do
  ...
  create_table "books", primary_key: "isbn", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title"
    t.string "author"
    t.string "url"
    t.string "image_url"
